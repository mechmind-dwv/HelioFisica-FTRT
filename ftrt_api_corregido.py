"""
Sistema Interactivo FTRT + API - VERSIÓN CORREGIDA
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Servidor API FTRT - Versión Corregida')
    ...
    print(f"🚀 INICIANDO API FTRT CORREGIDA")
    print(f"📍 Host: {args.host}")
    print(f"🔌 Puerto: {args.port}")
    print(f"🌐 URL: http://{args.host}:{args.port}")
    print(f"📊 Endpoints disponibles:")
    print(f"   • POST /api/ftrt/calculate")
    print(f"   • POST /api/ftrt/report") 
